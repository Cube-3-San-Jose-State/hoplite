...
int main()
{
    ...
    // schedule 3 tasks
    int id1 = scheduler.schedule_once(in_one_second, []()
                                      { std::cout << "one second once" << std::endl; });
    int id2 = scheduler.schedule_interval(
        in_one_second, std::chrono::milliseconds(500), []()
        { std::cout << "one second repeating" << std::endl; },
        5);
    int id3 = scheduler.schedule_once(in_three_seconds, []()
                                      { std::cout << "three seconds once" << std::endl; });
